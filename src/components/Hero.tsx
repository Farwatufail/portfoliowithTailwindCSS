  ...
  return (
    ...
    >
      ...
      <div className="container grid lg:grid-cols-2 min-h-screen pt-16">
        {/* Left Side (Image) */}
        <div
          className="hidden lg:block bg-cover h-[650px]"
          style={{
        ...
        <div className="flex justify-center items-center relative lg:static pb-23">
          ...
          {/* Text Content */}
          <div className="z-10 text-white text-[50px] sm:text-[100px] font-bold leading-tight text-center lg:text-left -translate-y-10">
            <p data-aos="zoom-in-up">I am</p>
            <p data-aos="zoom-in-up">Farwa</p>
            <p data-aos="zoom-in-up">Tufail</p>
          </div>
        </div>
      </div>
    </div>
